...
function Cards(props) {
    console.log(props)
    return (
        <div className="md:max-w-sm w-300 p-4 rounded-xl shadow-xl bg-black border border-zinc-800 hover:border-white transition-all duration-300 hover:transform hover:scale-105 group">
